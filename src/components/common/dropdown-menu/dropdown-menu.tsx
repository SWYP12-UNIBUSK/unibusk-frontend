  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          `
            z-dropdown max-h-(--radix-dropdown-menu-content-available-height)
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        `
          relative flex cursor-default items-center gap-1.25 px-2.5 py-1.5
          text-sm outline-hidden select-none
          focus:bg-accent focus:text-accent-foreground
          data-disabled:pointer-events-none data-disabled:opacity-50
          data-inset:pl-8
          data-[variant=destructive]:text-error
          data-[variant=destructive]:focus:bg-error/10
